...
<div id="form">
    <form method="POST">
        ...
        <input type="radio" name="optionSearchUser" id="" value="id_fabricante" required>Código<br>
        <input type="radio" name="optionSearchUser" id="" value="nome" required>Nome<br><br>

        <b>Ordenar por:</b> <br>
        <input type="radio" name="optionOrderUser" id="" value="id_fabricante" required>Código<br>
    ...
    try {
        ...
        if ($optionSearchUser != "") {
            if ($valorUser == "") {
                ...
                $sql = ("SELECT * FROM fabricante ORDER BY $optionOrderUser;");
            } elseif ($optionSearchUser == "nome") {
                $sql = ("SELECT * FROM fabricante WHERE $optionSearchUser LIKE '$valorUser%' ;");
            } else {
                $sql = ("SELECT * FROM fabricante WHERE $optionSearchUser LIKE '$valorUser%' ORDER BY $optionOrderUser;");
            }
        } else {
    ...
    ?>
            <tr>
                ...
                <td><a href='addfabricante.php?acao=editar&id_fabricante=<?php echo $linha['id_fabricante']; ?>'><img class="icon" src="img/edit.png" alt=""></a></td>
                <td><a href="javascript:excluirRegistro('addfabricante.php?acao=excluir&id_fabricante=<?php echo $linha['id_fabricante']; ?>')"><img class="icon" src="img/delete.png" alt=""></a></td>
            </tr>
        <?php } ?>
        </table>
