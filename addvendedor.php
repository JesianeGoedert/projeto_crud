...
<div id="form">
    <form action="acaovendedor.php" method="post">
        <b>Insira os dados abaixo:</b> <br>
        <input readonly  type="number" name="id_vendedor" id="id_vendedor" value="<?php if ($acao == "editar") echo $dados['id_vendedor']; else echo 0; ?>"><br><br>
        <b>Nome:</b><br>
