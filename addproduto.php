<!DOCTYPE html>
<?php
include_once "acaoproduto.php";
$acao = isset($_GET['acao']) ? $_GET['acao'] : "";
$dados;
if ($acao == 'editar'){
    $codigo = isset($_GET['id_produto']) ? $_GET['id_produto'] : "";
    if ($codigo > 0)
...
<div id="form">
    <form action="acaoproduto.php" method="post">
        ...
        <input readonly  type="number" name="id_produto" id="id_produto" value="<?php if ($acao == "editar") echo $dados['id_produto']; else echo 0; ?>"><br><br>
        <b>Nome:</b><br>
        <input required=true   type="text" name="nome" id="nome" value="<?php if ($acao == "editar") echo $dados['nome']; ?>"><br>
        <b>Valor:</b><br>
        <input required=true   type="double" name="valor" id="valor" value="<?php if ($acao == "editar") echo $dados['valor']; ?>"><br>
