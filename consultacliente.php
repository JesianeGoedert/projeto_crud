...
<div id="form">
    <form method="POST">
        ...
        <b>Ordenar por:</b> <br>
        <input type="radio" name="optionOrderUser" id="" value="id_cliente" required>Código<br>
    ...
    ?>
            <tr>
                ...
                <td><a href='addcliente.php?acao=editar&id_cliente=<?php echo $linha['id_cliente']; ?>'><img class="icon" src="img/edit.png" alt=""></a></td>
                <td><a href="javascript:excluirRegistro('addcliente.php?acao=excluir&id_cliente=<?php echo $linha['id_cliente']; ?>')"><img class="icon" src="img/delete.png" alt=""></a></td>
            </tr>
        <?php } ?>
        </table>
